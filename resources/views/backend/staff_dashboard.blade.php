...
<head>
    ...
    <link href="{{url('')}}/assets/extra-libs/css-chart/css-chart.css" rel="stylesheet">
...
<div class="page-wrapper">
            ...
            <div class="row">
                <img src="{{url('')}}/assets/images/welcome.jpg" width="100%" alt="" />
            </div>
            <!-- ============================================================== -->
            ...
            <footer class="footer text-center">
                ...
                <a href="{{url('')}}/https://wrappixel.com">WrapPixel</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
